...
## My AA has not deployed correctly and I can't see it in my aracde accounts

To recover your account you can:

- Get your AA address from your wallet (check the deploy account transaction)
- Go to AA's then Recover Account
- Enter your address and recover account
