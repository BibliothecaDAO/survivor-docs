...
Adventurers can only carry 19 items in their bags. Items can be dropped and swapped from the item card. If you drop an item you will lose the associated boosts.
